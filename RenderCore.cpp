...
RenderCore::RenderCore(UINT width, UINT height, std::wstring name) :
    m_frameIndex(0),
...
void RenderCore::LoadPipeline()
{
    ...
    ThrowIfFailed(factory->MakeWindowAssociation(ApplicationWindow::GetHwnd(), DXGI_MWA_NO_ALT_ENTER));
...
void RenderCore::GetHardwareAdapter(
...
void RenderCore::PopulateCommandList()
{
...
// fences to determine GPU execution progress.
    ...
    D3D12_RESOURCE_BARRIER barrierTransitionRT = CD3DX12_RESOURCE_BARRIER::Transition(m_renderTargets[m_frameIndex].Get(), D3D12_RESOURCE_STATE_PRESENT, D3D12_RESOURCE_STATE_RENDER_TARGET);
    m_commandList->ResourceBarrier(1, &barrierTransitionRT);
    ...
    D3D12_RESOURCE_BARRIER barrierTransitionPresent = CD3DX12_RESOURCE_BARRIER::Transition(m_renderTargets[m_frameIndex].Get(), D3D12_RESOURCE_STATE_RENDER_TARGET, D3D12_RESOURCE_STATE_PRESENT);
    m_commandList->ResourceBarrier(1, &barrierTransitionPresent);

    ThrowIfFailed(m_commandList->Close());
}

void RenderCore::WaitForPreviousFrame()
{
